...
final class FkTypography {
  ...
  FkTypography copyWith({
    ...
    var result = FkTypography(
      heading01: heading01 ?? _heading01,
      heading02: heading02 ?? _heading02,
      heading03: heading03 ?? _heading03,
      heading04: heading04 ?? _heading04,
      display01: display01 ?? _display01,
      display02: display02 ?? _display02,
      display03: display03 ?? _display03,
      headline01: headline01 ?? _headline01,
      headline02: headline02 ?? _headline02,
      headline03: headline03 ?? _headline03,
      headline04: headline04 ?? _headline04,
      headline05: headline05 ?? _headline05,
      headline06: headline06 ?? _headline06,
      bodyTiny: bodyTiny ?? _bodyTiny,
      bodyMini: bodyMini ?? _bodyMini,
      bodySmall: bodySmall ?? _bodySmall,
      bodyDefault: bodyDefault ?? _bodyDefault,
      bodyLarge: bodyLarge ?? _bodyLarge,
      bodyExtra: bodyExtra ?? _bodyExtra,
      buttonTiny: buttonTiny ?? _buttonTiny,
      buttonMini: buttonMini ?? _buttonMini,
      buttonSmall: buttonSmall ?? _buttonSmall,
      buttonDefault: buttonDefault ?? _buttonDefault,
      buttonLarge: buttonLarge ?? _buttonLarge,
      buttonExtra: buttonExtra ?? _buttonExtra,
    );
    return result;
  }
